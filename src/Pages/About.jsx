...
const About = () => {
  ...
  return (
    <section className="about-section bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12" data-aos="fade-up">
          <h1 className="text-4xl font-bold text-[#01849b]">About Us</h1>
          <p className="text-xl text-gray-600 mt-4">We are an e-commerce platform focused on providing top-notch sports equipment and accessories.</p>
        </div>
